    ...
    public void initFirebase() {
        ...
        try (InputStream serviceAccount = openCredentials()) {
            if (serviceAccount == null) {
                logger.warn("Firebase Admin SDK no se inicializo: configure FIREBASE_SERVICE_ACCOUNT_JSON, FIREBASE_SERVICE_ACCOUNT_PATH o GOOGLE_APPLICATION_CREDENTIALS.");
                return;
            }
