...
export const profileService = {
  ...
  listPublicStaff: () => request({ baseURL: PROFILES_API_BASE_URL, url: '/api/perfiles/staff/listado', method: 'GET' }),
  listStaff: () => request({ baseURL: PROFILES_API_BASE_URL, url: '/api/perfiles/staff/listado', method: 'GET', authRequired: true }),
